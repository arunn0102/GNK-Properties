...
//           <Link
//             href="/contact"
//             className="flex items-center gap-2 px-6 py-2.5 rounded-full bg-yellow-200 text-black font-semibold shadow-md hover:shadow-yellow-500/40 hover:scale-105 transition-all duration-300"
//           >
//             <Phone size={18} />
//             Contact
//           </Link>
...
//                 className="flex items-center gap-2 px-6 py-2.5 rounded-full bg-yellow-400/90 text-black font-semibold shadow-md hover:bg-yellow-300 hover:scale-105 transition-all duration-300"
//               >
//                 <LogIn size={18} />
//                 Login
//               </Link>
//               <Link
//                 href="/signup"
//                 className="flex items-center gap-2 px-6 py-2.5 rounded-full bg-transparent border border-yellow-400 text-yellow-300 font-semibold hover:bg-yellow-400 hover:text-black hover:scale-105 transition-all duration-300"
//               >
//                 <UserPlus size={18} />
//                 Signup
//               </Link>
...
//               className="flex items-center gap-2 px-6 py-2.5 rounded-full bg-red-600 text-white font-semibold shadow-md hover:bg-red-500 hover:scale-105 transition-all duration-300"
//             >
//               <LogOut size={18} />
//               Logout
//             </button>
...
//                     }}
//                     className="flex items-center gap-3 mt-2 px-8 py-2.5 rounded-full bg-yellow-400/90 text-black font-semibold shadow-md hover:bg-yellow-300 transition-all duration-300"
//                   >
//                     <LogIn size={20} />
//                     Login
//                   </Link>
...
//                     href="/signup"
//                     onClick={() => setIsOpen(false)}
//                     className="flex items-center gap-3 mt-2 px-8 py-2.5 rounded-full border border-yellow-400 text-yellow-300 font-semibold hover:bg-yellow-400 hover:text-black transition-all duration-300"
//                   >
//                     <UserPlus size={20} />
//                     Signup
//                   </Link>
...
//                     handleLogout();
//                   }}
//                   className="flex items-center gap-3 mt-2 px-8 py-2.5 rounded-full bg-red-600 text-white font-semibold shadow-md hover:bg-red-500 transition-all duration-300"
//                 >
//                   <LogOut size={20} />
//                   Logout
//                 </button>
