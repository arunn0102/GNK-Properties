...
//         >
//           {/* OVERVIEW */}
//           <h2 className="text-3xl font-semibold text-red-800 mb-4 flex items-center gap-2">
//             <Info className="w-7 h-7 text-red-700" /> Overview
//           </h2>
...
//           {details && (
//             <>
//               <h3 className="text-2xl font-semibold text-red-800 mb-5 flex items-center gap-2">
...
//                     >
//                       <h4 className="text-sm uppercase tracking-wide text-red-700 font-medium mb-1">
//                         {key.replace(/_/g, " ")}
//                       </h4>
...
//             className="mt-10 bg-gradient-to-r from-[#4c0000] via-[#7a0000] to-[#b30000] text-white p-10 rounded-3xl shadow-lg"
//           >
...
//                 className="flex items-center gap-2 bg-white text-red-700 px-5 py-2 rounded-full font-medium shadow-md hover:bg-amber-100 transition"
//               >
...
//             <Link
//               href="/services"
//               className="inline-flex items-center gap-2 px-6 py-3 rounded-full bg-gradient-to-r from-[#4c0000] via-[#7a0000] to-[#b30000] text-white font-medium hover:opacity-90 transition-all duration-300 shadow-md"
//             >
//               ← Back to Services
//             </Link>
//           </div>
...
export default async function ServiceDetails({ params }) {
  ...
  return (
    <section className="min-h-screen bg-gradient-to-b from-white via-amber-50 to-white">
      {/* HERO SECTION */}
      <div className="relative h-[65vh] w-full overflow-hidden rounded-b-[4rem] shadow-lg">
        <img
          src={image}
      ...
      {/* MAIN CONTENT */}
      <div className="max-w-6xl mx-auto -mt-20 px-6 md:px-10 relative z-10">
        <div className="bg-white/80 backdrop-blur-xl border border-amber-100 shadow-2xl rounded-3xl p-10 md:p-14">
          {/* OVERVIEW */}
          <h2 className="text-3xl font-semibold text-red-800 mb-4 flex items-center gap-2">
            <Info className="w-7 h-7 text-red-700" /> Overview
          </h2>
          ...
          {/* CONTACT CTA */}
          <div className="mt-10 bg-gradient-to-r from-[#4c0000] via-[#7a0000] to-[#b30000] text-white p-10 rounded-3xl shadow-lg">
            <h3 className="text-2xl font-semibold mb-3">
              Interested in this Opportunity?
            </h3>
            <p className="text-amber-100 mb-6">
              Contact GNK Associates for more information or to schedule a
              visit.
            </p>
            <div className="flex flex-col sm:flex-row gap-4">
              <a
